...
import com.banking.account.cmd.api.command.OpenAcountCommand;
...
public class OpenAccountController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> openAccount(@RequestBody OpenAcountCommand command) {
        ...
        try {
            ...
            return new ResponseEntity<>(
                    new OpenAccountResponse("La cuenta del banco se ha creado exitosamente.", id),
                    HttpStatus.CREATED
            );
            ...
            return new ResponseEntity<>(
                    new OpenAccountResponse(safeErrorMessage, id),
